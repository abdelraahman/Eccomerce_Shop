    ...
    <div>
        ...
        <div class=" container">
            ...
            <div class=" table-box table-responsive">
                <table class="sort-table-product table table-striped table-bordered">
                    ...
                    <tbody>
                        @foreach ($products as $item)
                            <tr>
                                <?php
                                $totalPrice += $item->qty * $item->product->sell_price;
                                ?>
                                <td style="color: #344767">{{ ++$i }}</th>
                                <td style="color: #344767">{{ $item->product->title }}</td>
                                <td class="max-word" style="color: #344767">{{ $item->qty }}</td>
                                <td><img class="img-tumbnail" src="{{ URL::asset($item->product->image) }}"
                                        alt="{{ $item->image }}" width="150" height="150"></td>
                                <td class="max-word" style="color: #344767">
                                    {{ $item->qty * $item->product->sell_price . '$' }}
                                </td>
                                <td>
                                    <div>
                                        <div class="row">
                                            <div class="col-sm">
                                                <a class="btn btn-danger"
                                                    href="{{ route('mycart.delete', $item->id) }}">Delete</a>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                ...
                <h2 class="product-card-details-product-name">TOTAL PRICE = {{ $totalPrice . '$' }} </h2>
